      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="absolute right-2 bottom-4 hidden lg:block">
          <button
            ...
            className="flex cursor-pointer items-center gap-2 rounded-full bg-gradient-to-b from-primary to-secondary px-4 py-3 text-white shadow-lg transition-colors hover:scale-105 hover:bg-gradient-to-b hover:from-secondary hover:to-primary duration-300 dark:shadow-lg"
          >
